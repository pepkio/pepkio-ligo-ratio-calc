"""Typed API request/response models for ligo-ratio-calc."""
...
from .exceptions import PepkioRunError
...
class RunResult(BaseModel):
    ...
    def raise_for_error(self) -> None:
        """Raise PepkioRunError if the run response includes an error field."""
        if self.error is None:
            return
        err = self.error
        raise PepkioRunError(
