"""HTTP client for the Pepkio ligo-ratio-calc tool."""
...
class PepkioClient:
    """Client for Pepkio Tools REST API (ligo-ratio-calc)."""
    ...
    def _require_api_key(self) -> None:
        if not self._api_key:
            raise PepkioAuthError(
                "API key required. Set PEPKIO_API_KEY (or LOCAL_PEPKIO_API_KEY for local dev), "
    ...
    def _handle_response(self, response: httpx.Response) -> dict[str, Any]:
        ...
        msg = error.get("message") or response.reason_phrase or "Request failed"
